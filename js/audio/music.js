...
const lushDrips = [
    { note: NOTE.REST, dur: 1.5 }, { note: NOTE.C5, dur: 0.15 },
    { note: NOTE.REST, dur: 2.5 }, { note: NOTE.E5, dur: 0.15 },
    { note: NOTE.REST, dur: 1.8 }, { note: NOTE.G5, dur: 0.12 },
    { note: NOTE.REST, dur: 2.2 }, { note: NOTE.D5, dur: 0.15 },
    { note: NOTE.REST, dur: 1.6 }, { note: NOTE.A5, dur: 0.12 },
    { note: NOTE.REST, dur: 2.0 },
];
    ...
    play(track) {
        ...
        if (track === 'overworld') {
            ...
            playLoop([
                { notes: dungeonMelody, type: 'square', gain: 0.15 },
                { notes: dungeonBass, type: 'sine', gain: 0.2 },
                { notes: lushDrips, type: 'sine', gain: 0.06 },
            ], track, gen);
        } else if (track === 'shop') {
            playLoop([
