...
**Status:** Living document · Gate 2 approved; Phase 0 + L2 shipped · derived from the approved Section 1 arc in [MULTI_AGENT_PLAN.md](MULTI_AGENT_PLAN.md) · grounded against the code at `VERSION 1.3.1`.
